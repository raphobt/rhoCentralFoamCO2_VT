...
&                dedr_T,&
&                dsdr_T, dsdT_r, dpdr_T,& ! Modif HRM sound2.f90
&                drdp_T, dTdp_r ! Modif HRM sound3.f90
       CONTAINS
!
!
!===============================================================================================
...
!
!==================================================================================================================
      SUBROUTINE drdp_T(T,v,deriv) !kg/m3/Pa
!=================================================================================================================
        IMPLICIT NONE
!IN/OUT
        REAL(pr) :: T,v,deriv
...
&                             phi_r_dddelt, phi_r_ddtau, phi_r_ddeltdtau )
!        
        dp_dT_r = rho * R * (1_pr+delt*phi_r_ddelt-tau*delt*phi_r_ddeltdtau )


        deriv = 1_pr / dp_dT_r


      END SUBROUTINE dTdp_r
!
...
!        
      ...
      SUBROUTINE dsdr_T(T,v,deriv) !J/kg/kg/m3
!=================================================================================================================
        IMPLICIT NONE
!IN/OUT
        REAL(pr) :: T,v,deriv
...
&                             phi_r_dddelt, phi_r_ddtau, phi_r_ddeltdtau )
!        
        ds_dr_T = - R / rho * (1_pr+delt*phi_r_ddelt-tau*delt*phi_r_ddeltdtau )

        deriv = ds_dr_T

      END SUBROUTINE dsdr_T
!
      SUBROUTINE dsdT_r(T,v,deriv) !J/kg/K
!=================================================================================================================
        IMPLICIT NONE
!IN/OUT
        REAL(pr) :: T,v,deriv
...
&                             phi_r_dddelt, phi_r_ddtau, phi_r_ddeltdtau )
!        
        ds_dT_r = - R / T * tau * tau * (phi0_ddtau+phi_r_ddtau)

        deriv = ds_dT_r

      END SUBROUTINE dsdT_r
!
!==================================================================================================================
      SUBROUTINE dpdr_T(T,v,deriv) !Pa/kg/m3
!=================================================================================================================
        IMPLICIT NONE
!IN/OUT
        REAL(pr) :: T,v,deriv
...
&                             phi_r_dddelt, phi_r_ddtau, phi_r_ddeltdtau )
!
        dp_dr_T  = R * T * (1_pr + 2_pr*delt*phi_r_ddelt + delt*delt*phi_r_dddelt) 
!
        deriv = dp_dr_T 

      END SUBROUTINE dpdr_T
