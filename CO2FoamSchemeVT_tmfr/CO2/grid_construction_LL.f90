...
&                                         T_sat_pmax,res_pmax_LL,T_liq_meta
      ...
      REAL(pr), DIMENSION (NNN_sat_LL,NNN_sat_LL)  ::  T_guess_sat2,v_guess_sat2
!
